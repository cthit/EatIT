...
export default class Timer extends Component {
  ...
  render() {
    ...
    if (timerStarted) {
      return (
        <div className="container-part">
          <div className="container-content">
            <h3 className="text-extra-style">🕑 Time until food's ready:</h3>
      ...
      return (
        <div className="timer-area container-part" id="count-down-timer">
          <div className="container-content">
            <h3>
              <label id="timer-box-label">🕑 Enter time until delivery</label>
            </h3>
            <div className="timer-box">
              <form className="start-timer" onSubmit={this.onSubmit}>
                <input
                  type="integer"
                  name="minutes"
                  placeholder="Minutes"
